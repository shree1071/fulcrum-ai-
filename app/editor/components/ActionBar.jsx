...
export default function ActionBar() {
  return (
    <div className="absolute bottom-0 left-0 right-0 h-12 bg-[#0d1117]/95 backdrop-blur-md border-t border-gray-800/50 flex items-center justify-center gap-6 z-20">
      {/* Like */}
      <button className="flex items-center gap-2 px-3 py-1.5 hover:bg-gray-800 rounded transition-colors group">
