...
export default function Toolbar({ onCompileWiki }) {
  return (
    <div className="flex items-center gap-2 px-4 py-2 bg-[#0d1117] border-b border-gray-800/50">
      {/* Save */}
      <button 
      ...
      <button 
        ...
        className="px-3 py-1.5 bg-indigo-600 hover:bg-indigo-700 rounded text-sm font-medium transition-colors flex items-center gap-2"
        title="Compile Wiki"
      >
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
